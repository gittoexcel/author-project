...
function generateBooks(books) {
    ...
    books.forEach(book => {
        ...
        colImg.innerHTML = `<img src="${book.img}" class="img rounded shadow-lg d-block m-auto" alt="Sample Art">`;
        ...
        if (book.buttons && book.buttons.length > 0) {
            let btnObj = book.buttons[0];
